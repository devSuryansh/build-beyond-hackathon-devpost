...
TypeScript, Vite, JavaScript, HTML, CSS, Web Audio API, Vitest

## Links

- Source: https://github.com/devSuryansh/build-beyond-hackathon-devpost
- Live demo: https://cdn.jsdelivr.net/gh/devSuryansh/build-beyond-hackathon-devpost@main/docs/index.html
- StackBlitz: https://stackblitz.com/github/devSuryansh/build-beyond-hackathon-devpost

## Gallery images

- docs/demo/stillroom-home.png
- docs/demo/stillroom-session.png
- docs/demo/stillroom-after-session.png
